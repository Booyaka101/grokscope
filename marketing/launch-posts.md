...
> Replace `GITHUB_URL` with the repo link (and `NPM_URL` with https://www.npmjs.com/package/grokscope) before posting.
...
MIT licensed. `npm i -g grokscope` → GITHUB_URL
